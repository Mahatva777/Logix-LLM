  ...
  return (
    <div className="mlx-shell min-h-screen w-full">
      <style>{`
        ...
        /* Sandbox tab (Advance Generative UI): deliberately NOT the same
           blue-gradient treatment as the other three -- a dashed bronze
           outline + dot flags it as the isolated, non-compliance-checked
           mode before the user even clicks into it. */
